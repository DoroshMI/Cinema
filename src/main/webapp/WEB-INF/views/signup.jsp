...
<body>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				<li><a href="https://planetakino.ua/lvov/showtimes/">Розклад</a></li>
	...
	<form:form modelAttribute="user" action="/signup" method="post"
		...
		<div class="form-group">
			<span style="color: red">${usernameException}</span> <label
				for="inputName" class="col-sm-2 control-label">Name</label>
			<div class="col-sm-5">
