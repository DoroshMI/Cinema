		...
		<div class="row">
													...
													<div style="margin-right: 5px;" class=" seatNumber">
														...
														<c:choose>
															<c:when test="${principal == null}">
																<a href="javascript:PopUpShow()" style="color: white;">${seat.coordinate.column+1}</a>
															</c:when>
															<c:otherwise>
			...
			<div class="col-xs-12 col-md-4">
				...
				<a id="btn-bye-tickets"
					href="/choose-tickets?showtimeId=365876&amp;theaterId=pk-lvov"
					class="batton">Kупиtи квитки</a>
